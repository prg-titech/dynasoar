...
/usr/local/cuda/bin/nvcc -std=c++11 -DHEAP_SIZE=500 -O3 -use_fast_math example/nbody/soa/nbody_baseline.cu -I. -arch compute_61 --expt-relaxed-constexpr -maxrregcount=64 -o bin/nbody_baseline
