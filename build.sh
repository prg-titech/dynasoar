...
/usr/local/cuda/bin/nvcc -std=c++11 -DHEAP_SIZE=500 -O3 example/game-of-life/soa/gol.cu example/game-of-life/soa/rendering.cu example/game-of-life/soa/dataset_loader.cu -I. -arch compute_50 --expt-relaxed-constexpr -maxrregcount=64 -o bin/gol -lSDL2 -DNDEBUG
