...
/usr/local/cuda/bin/nvcc -std=c++11 -DHEAP_SIZE=500 -O3 example/game-of-life/soa/gol.cu example/game-of-life/soa/rendering.cu -I. -arch compute_61 --expt-relaxed-constexpr -maxrregcount=64 -o bin/gol -lSDL2
/usr/local/cuda/bin/nvcc -std=c++11 -DHEAP_SIZE=500 -O3 example/game-of-life/soa/gol_baseline.cu example/game-of-life/soa/rendering.cu -I. -arch compute_61 --expt-relaxed-constexpr -maxrregcount=64 -o bin/gol_baseline -lSDL2