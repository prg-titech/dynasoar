...
/usr/local/cuda/bin/nvcc -ccbin=clang++-3.8 -std=c++11 -DHEAP_SIZE=500 -O3 example/game-of-life/soa/gol.cu example/game-of-life/soa/rendering.cu -I. -arch compute_61 --expt-relaxed-constexpr -maxrregcount=64 -o bin/gol -lSDL2
