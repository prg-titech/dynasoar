...
static __device__ uint64 free_mem_g;
/** maximum memory that can be allocated, B */
static __device__ uint64 max_alloc_mem_g;
/** total Halloc memory (incl. CUDA memory), B */
static __constant__ uint64 total_mem_g;
/** memory assigned to CUDA allocator, B */
static __constant__ uint64 cuda_mem_g;
